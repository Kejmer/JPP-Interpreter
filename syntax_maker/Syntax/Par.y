...
Stmt : Block { Syntax.Abs.BStmt $1 }
     | BasicType 'mut' Ident '=' Expr { Syntax.Abs.DeclMut $1 $3 $5 }
     | BasicType Ident '=' Expr { Syntax.Abs.DeclConst $1 $2 $4 }
...
BasicType : BasicType '[]' { Syntax.Abs.Arr $1 }
          ...
          | BasicType 'lambda_type' '(' ListType ')' { Syntax.Abs.Fun $1 $4 }
          | BasicType 'proc_type' '[' ListArg ']' '(' ListType ')' { Syntax.Abs.TProc $1 $4 $7 }
